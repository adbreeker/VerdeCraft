...
import verdecraft.verdecraft.handlers.items.NuclearWasteDropOrPlace;
...
public class AnimalsContaminatedByNuclearWastes implements Listener
{
    ...
    public void onAnimalsContaminated(EntityPotionEffectEvent event)
    {
        if(event.getEntity() instanceof LivingEntity)
        {
            ...
            int contaminated = 0;
            for(PotionEffect effect : NuclearWasteDropOrPlace.NuclearWastePotionMeta().getCustomEffects())
            {
